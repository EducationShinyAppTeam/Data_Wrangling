          ...
          tags$ol(
            ...
            tags$ol(
              ...
              tags$li("In Wrangling Part 3, explore the verbs of Uniting,
                      Separating, and Mutating along with some helper verbs."),
            ...
            column(
              ...
              tabsetPanel(
                ...
                tabPanel(
                  title = "Selecting",
                  br(),
                  p(tags$em("Selecting"), "refers to the action of choosing which
                    case attributes/characteristics we want to keep from an
                    input data frame for an output data frame. For tidy data,
                    these means that we are selecting which columns to keep and
                    which to leave behind. The function", tags$code("select"),
                    "from the", tags$code("{dplyr}"), "package allows us to apply
                    the selecting action."),
